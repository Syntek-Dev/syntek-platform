...
├── CLAUDE.md                  # PRIMARY - Project configuration and standards
├── SYNTEK-GUIDE.md            # Guide for using Syntek Dev Suite agents
├── settings.local.json        # Local Claude Code settings (private)
